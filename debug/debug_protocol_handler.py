...
try:
    ...
    required_methods = ['run_stdio', 'run', 'start', 'serve', 'handle_stdio', 'handle_message']
    ...
    for method in methods:
        if any(keyword in method.lower() for keyword in ['run', 'start', 'serve', 'handle', 'process', 'execute']):
            print(f"  • {method}")
